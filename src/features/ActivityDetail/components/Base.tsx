    ...
    <div className="min-h-screen p-2 mb-10">
      <div className="">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-[#1e1e1e]/90">
                    {formatTanggal(String(transactions?.out_date))}
                  </span>
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-[#37393d]">
                  ...
                  <span className="font-light text-sm">
                    {formatCurrency(String(transactions?.total_price))}
                  </span>
                </div>
                <div className="flex justify-between text-[#37393d]">
                ...
                <div className="flex justify-between text-[#37393d]">
                  <span>PPN</span>
                  <span className="font-light text-sm">
                    {formatCurrency(String(transactions?.ppn))}
                  </span>
                </div>
                ...
                <div className="flex justify-between border-[#efecff]">
                  ...
                  <span className="font-medium text-lg text-[#1e1e1e]">
                    {formatCurrency(String(transactions?.grand_total))}
                  </span>
                </div>
                <div className="flex justify-between pt-3 border-t border-[#efecff]">
        ...
        <div className="flex justify-end gap-4 mt-8">
          {/* Tombol Cetak Struk */}
          <Link to={`/struk/${transactions?.out_no}`}>
            <button
          ...
          {/* Tombol Simpan PDF */}
          <Link to={`/invoice-pdf/${transactions?.out_no}`}>
            <button
              className="cursor-pointer group flex items-center gap-2 px-6 py-3 rounded-lg font-medium 
